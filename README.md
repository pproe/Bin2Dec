...
-   [x] User can enter up to 8 binary digits in one input field (Bits are represented as buttons for usability)
-   [x] User must be notified if anything other than a 0 or 1 was entered (Dissallowed due to button implementation)
